...
def profile(request,pk):
     ...
     user_post_lengh = len(user_posts)
     ...
     context = {
          ...
          'user_post_length':user_post_lengh,
...
def settings(request):
     ...
     user_profile = Profile.objects.get(user=request.user)  #request.user is authenticated user / loggedin user
